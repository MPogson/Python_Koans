...
class AboutLists(Koan):
    ...
    #I dont like this terminology. When you say pop your implying a stack
    # that always pops the last thing in the stack. givng it an index
    #doesnt make sense since this is stack. pop should ALWAYS get the last
    #Item that was put onto the stack.  thats more of a get not a pop.
